...
import binarytreereview.exceptions.ElementNotFoundException;
import binarytreereview.exceptions.EmptyCollectionException;

/**
 * LinkedBinaryTree implements the BinaryTreeADT interface
 * 
 * Modified from Java Foundations example
 * 
...
public class LinkedBinaryTree<T> implements Iterable<T>
{
	 ...
	 *
	 * @return a link to the left subtree to the tree
	 */
	...
	{
		if ((next == null) || (next.getElement().equals(targetElement)))
			return next;
